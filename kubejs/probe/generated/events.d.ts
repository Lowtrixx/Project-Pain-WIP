...
declare const BotanyPotsEvents: {
    /**
     * @at *server*
    */
onCropGrow(handler: (event: Internal.KubeJSBotanyPotsPlugin$CropGrowEvent) => void):void,
};
...
declare const FTBChunksEvents: {
     ...
     * @cancellable
    */
before(extra: Special.EntityType, handler: (event: Internal.BeforeEventJS) => void):void,
    /**
     * @at *server*
    */
after(extra: Special.EntityType, handler: (event: Internal.AfterEventJS) => void):void,
};
